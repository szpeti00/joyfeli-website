      ...
      <div class="col-12 position-relative m-0 p-0">
        ...
        <div class="bg-image-container animate-slide-in-left">
          <picture class="bg-image">
            ...
            <source media="(max-width: 575px)" srcset="/img/Feli_soca_phone.webp" type="image/webp">
            <source media="(max-width: 575px)" srcset="/img/Feli_soca_phone.jpg" type="image/jpeg">
            <!-- Desktop: full image -->
            <source srcset="/img/Feli_soca.webp" type="image/webp">
            <source srcset="/img/Feli_soca.jpg" type="image/jpeg">
            <img class="bg-image-img" src="/img/Feli_soca.jpg" alt="Voor Haar Background" width="1320" height="665" loading="eager" fetchpriority="high">
          </picture>
        </div>
        <!-- Text overlay -->
    ...
    <div class="custom-tabs">
      ...
      <div class="dropdown d-block d-md-none text-center fs-4">
        ...
        <ul class="dropdown-menu" aria-labelledby="mobileDropdown" role="tablist">
          <li>
            <button class="dropdown-item active fs-4" data-bs-toggle="tab" data-bs-target="#forher" type="button" role="tab" aria-selected="true" aria-label="Voor haar">
              Voor haar
            </button>
          </li>
          <li>
